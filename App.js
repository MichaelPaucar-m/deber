  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <View style={styles.container}>
        <Text style={styles.titulo}>Longin</Text>
        <Text style={styles.subTitle}>Ingresar a tu cuenta </Text>
        <TextInput 
          placeholder="e-mail"
        ...
        />
        <Text style={styles.forgotPassword}>No recuerdas tu contraseña?</Text>
        <Text style={styles.forgotPassword}>No tienes una cuenta </Text> 
        <TextInput style={styles.textInputBut}
